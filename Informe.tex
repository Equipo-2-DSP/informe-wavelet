...
\section{Resultados}
A continuación, presentamos los resultados obtenidos para la siguientes imágenes de prueba:
%agregar imagenes, label

Luego de pruebas con diferentes wavelet, algoritmos de umbralización y cantidad de niveles, se llego a que resultado se obtuvo con $agregar los mejores parametros$, obteniéndose las imágenes filtradas y reconstruidas.

%agregar imagenes filtradas.

Para corrobar este resultado presentamos las siguientes tablas comparativas de las distintas combinaciones de parámetros descritos en el item 4-iii en la sección \ref{asd} para las imágenes 
$agregar label$ 
